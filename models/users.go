...
var (
	userAllColumns            = []string{"id", "firstname", "lastname", "email", "password", "created_on", "updated_at"}
	userColumnsWithoutDefault = []string{"firstname", "lastname", "email", "password"}
	userColumnsWithDefault    = []string{"id", "created_on", "updated_at"}
